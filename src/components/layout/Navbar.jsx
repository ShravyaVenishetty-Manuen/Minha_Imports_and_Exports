            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.name}
                  to={link.path}
                  className={`font-body text-[13px] font-medium tracking-[0.08em] transition-all duration-300 relative py-1 hover:text-brand-red ${
                    isActive 
              ...
              {navLinks.map((link, idx) => {
                ...
                return (
                  ...
                  >
                    <Link
                      to={link.path}
                      className={`font-body text-lg font-medium tracking-[0.08em] transition-all py-2 block ${
                        isActive ? 'text-brand-red font-bold border-b-2 border-brand-red' : 'text-text-gray hover:text-brand-red'
                      }`}
                    >
                      {link.name}
                    </Link>
